...
<!-- Mirrored from webdesign-finder.com/html/taxadvisor/services.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 06 Mar 2018 11:40:51 GMT -->
<head>
    <meta charset="utf-8"/>
            ...
            <div class="over_header_ins col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="row">
                    ...
                    <div class="text-right col-lg-10 col-md-10 col-sm-11 col-xs-12">
                        <span class="hr_last">
                            <img src="{{asset('frontend/images/phone.png')}}" alt=""/>1-800-300-2121</span>
                        <span>
                            <img src="{{asset('frontend/images/mail.png')}}" alt=""/>Support@gmail.com</span>
                        <span>
                            <img src="{{asset('frontend/images/adress.png')}}" alt=""/>528 tenth Avenue Boston, BT 58966</span> 
                    </div>
                </div>
            </div>
        </div>
...
<header class="header_type_2">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="row">
                        ...
                        <div class="button_header col-lg-3 col-md-3 col-sm-4 col-xs-12">
                            <a class="button_flat button_flat_menu" href="{{route('home')}}">Account</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Mirrored from webdesign-finder.com/html/taxadvisor/services.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 06 Mar 2018 11:40:52 GMT -->
    </html> 
