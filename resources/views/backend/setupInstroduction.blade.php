                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title" style="color:#459245">Setup Instructions</h4><br>
                                <h4 class="page-title" style="margin-top:20px">2018/02/16 13:07:40</h4>
                                <ol class="breadcrumb float-right">
                                    <li class="breadcrumb-item"><a href="#">Altax</a></li>
                                    <li class="breadcrumb-item"><a href="#">setup Instructions</a></li>
                                </ol>
                                <div class="clearfix"></div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card-box">
                            ...
                            <p class="text-muted m-b-30 font-14">Download the account operations User Gude below.</p>
                                    ...
                                    <div class="p-20">
                                        <form class="form-horizontal" role="form">
                                            <div class="form-group row">
                                                <label class="col-3 col-form-label text-md-right"></label>
                                                <div class="col-6">
                                                    <a href="{{asset('userguide.pdf')}}"  class="btn btn-success" 
                                                    style="background-color:#00b155;text-align:center;padding-top:10px;color:#fff;border:1px solid #00b155;height:60px;width:300px"><b>User Guide</b></h4></a>
                                                </div>
                                                <div class="col-3">
                                                </div>
                                            </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="p-20">
                                        <form class="form-horizontal" role="form">
                                            <div class="form-group row">
                                                <label class="col-5 col-form-label text-md-right"></label>
                                                <div class="col-6">
