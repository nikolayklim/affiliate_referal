            ...
            <div class="container" style="margin-top:30px">
                <div class="row">
                    <div class="col-md-11 col-md-offset-2">
                        ...
                        <h4 class="m-t-0 header-title" style="text-align:center;color:#459245"><b>Update a new Post</b></h4>
                            ...
                            <div class="panel-body" style="background-color:white;">
                                ...
                                <form method="post" action="{{url('/blog/'.$blog->id.'/update')}}"  class="form-control">
                                    {{ csrf_field() }}
                                    <div class="form-group">
                                        ...
                                        <div classs="col-md-8 col-md-offset-2" style="margin-top:20px">
                                            <textarea class="form-control" name="content" rows="10" cols="50">{{$blog->content}}
                                            </textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-3">
                                            <button type="submit" class="btn btn-success"> Update Blog</a></button>
                                        </div>
                                        <div class="col-sm-3" style="">
                                            <a href="{{route('admin.blog.index')}}" class="btn btn-success" style="background-color:#709ed5">Back</a>
                                        </div>
                                    </div>
                                </form>
