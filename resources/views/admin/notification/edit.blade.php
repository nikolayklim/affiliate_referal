                ...
                <div class="row" >
                    ...
                    <div class="col-md-8 col-md-offset-2">
                        <div class="panel panel-default">
                            <div class="panel-heading">Edit a new Post</div>
                                ...
                                <form method="post" action="{{url('/post/'.$post->id.'/update')}}">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div classs="col-md-8 col-md-offset-2" style="margin-top:20px">
                                            <textarea class="form-control" name="content" style="color:black" rows="10" cols="50">{{$post->content}}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <div class="col-sm-5">
                                            <button type="submit" class="btn btn-success"> Update Post</a></button>
                                        </div>
                                    </div>
                                </form>
                            </div>
